...
Static wedding planning site for GitHub Pages, with optional real-time sync through Firebase Firestore.
...
5. The app writes to the document path set in `window.WEDDING_SYNC_OPTIONS.documentPath`.
